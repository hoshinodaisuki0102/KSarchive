...
export function EnglishExamLabV2() {
  ...
  useEffect(() => setLocalPoints(Number(localStorage.getItem(pointKey()) ?? 0)), []);
  ...
  function swapSentences(from: number, to: number) {
  ...
  function handleSentenceClick(index: number) {
    ...
    swapSentences(selectedSentenceIndex, index);
  }
